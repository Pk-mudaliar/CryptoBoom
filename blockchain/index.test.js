...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and has multiple blocks',() => {
            beforeEach(() => {
                blockchain.addBlock({data : "Bhalu"});
    ...
    describe('validTransactionsData()', () => {
        ...
        describe('and the transasction data has atleast one malformed outputMap', () => {
        ...
        describe('and a ablock contains multiple identitical trasnactions' ,() => {
            it('returns false and logs an error', () => {
                newChain.addBlock({
                ...
                expect(blockchain.validTransactionData({ chain: newChain.chain})).toBe(false);    
                expect(errorMock).toHaveBeenCalled(); //something
            });
        });
    });
});